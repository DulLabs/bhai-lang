  ...
  "../interpreter/dist/index.js"(exports, module2) {
    ...
    var require_dist2 = __commonJS2({
      "../parser/dist/index.js"(exports2, module22) {
        ...
        var Expression = class {
          ...
          static getExpressionImpl(expressionType) {
            switch (expressionType) {
              case NodeType2.AdditiveExpression:
                return BhaiLangModule.getAdditiveExpression();
              case NodeType2.MultiplicativeExpression:
                return BhaiLangModule.getMultiplicativeExpression();
              case NodeType2.PrimaryExpression:
                return BhaiLangModule.getPrimaryExpression();
              case NodeType2.ParanthesizedExpression:
                return BhaiLangModule.getParanthesizedExpression();
              case NodeType2.AssignmentExpression:
                return BhaiLangModule.getAssignmentExpression();
              default:
                return BhaiLangModule.getIndentifierExpression();
            }
          }
          getBinaryExpression(expressionType, operatorToken) {
            var _a;
            let left2 = Expression.getExpressionImpl(expressionType).getExpression();
            while (((_a = this._tokenExecutor.getLookahead()) == null ? void 0 : _a.type) === operatorToken) {
              ...
              const right2 = Expression.getExpressionImpl(expressionType).getExpression();
              left2 = {
                type: NodeType2.BinaryExpression,
        ...
        var AdditiveExpression = class extends Expression {
          getExpression() {
            return this.getBinaryExpression(NodeType2.MultiplicativeExpression, TokenTypes.ADDITIVE_OPERATOR_TYPE);
          }
        };
        var AssignmentExpression2 = class extends Expression {
          constructor() {
            super(...arguments);
            this._additiveExpression = Expression.getExpressionImpl(NodeType2.AdditiveExpression);
          }
          getExpression() {
            var _a;
            const left2 = this._additiveExpression.getExpression();
            if (!this._isAssignmentOperator((_a = this._tokenExecutor.getLookahead()) == null ? void 0 : _a.type)) {
              return left2;
            }
            return {
              type: NodeType2.AssignmentExpression,
          ...
          _checkValidAssignmentTarget(node) {
            if (node.type === NodeType2.IdentifierExpression)
              return node;
        ...
        var IdentifierExpression2 = class extends Expression {
          getExpression() {
            ...
            return {
              type: NodeType2.IdentifierExpression,
              name
            };
          }
        };
        ...
        var MultiplicativeExpression = class extends Expression {
          getExpression() {
            return this.getBinaryExpression(NodeType2.PrimaryExpression, TokenTypes.MULTIPLICATIVE_OPERATOR_TYPE);
          }
        };
        var ParanthesizedExpression = class extends Expression {
          getExpression() {
            ...
            const expression = Expression.getExpressionImpl(NodeType2.AdditiveExpression).getExpression();
        ...
        var PrimaryExpression = class extends Expression {
          getExpression() {
            ...
            switch (token == null ? void 0 : token.type) {
              case TokenTypes.OPEN_PARENTHESIS_TYPE:
                return Expression.getExpressionImpl(NodeType2.ParanthesizedExpression).getExpression();
          ...
          _getLeftHandSideExpression() {
            return Expression.getExpressionImpl(NodeType2.IdentifierExpression).getExpression();
          }
        };
        var ExpressionStatement2 = class extends Statement {
          getStatement() {
            const expression = Expression.getExpressionImpl(NodeType2.AssignmentExpression).getExpression();
            this._tokenExecutor.eatTokenAndForwardLookahead(TokenTypes.SEMI_COLON_TYPE);
            return {
              type: NodeType2.ExpressionStatement,
              expression
            };
          }
        };
        ...
        var PrintStatement2 = class extends Statement {
          ...
          _getExpression() {
            return Expression.getExpressionImpl(NodeType2.AdditiveExpression).getExpression();
          }
        };
        var VariableStatement2 = class extends Statement {
          ...
          getStatement() {
            ...
            this._tokenExecutor.eatTokenAndForwardLookahead(TokenTypes.SEMI_COLON_TYPE);
            return {
              type: NodeType2.VariableStatement,
              declarations
            };
          }
          ...
          _getVariableDeclaration() {
            var _a, _b;
            const id = Expression.getExpressionImpl(NodeType2.IdentifierExpression).getExpression();
            ...
            return {
              type: NodeType2.VariableDeclaration,
              id,
              init
            };
          }
          _getVariableInitializer() {
            ...
            return Expression.getExpressionImpl(NodeType2.AssignmentExpression).getExpression();
          }
        };
    ...
    var Interpreter = class {
      ...
      interpret(code) {
        ...
        (_a = InterpreterModule.getVisitor(ast.type)) == null ? void 0 : _a.visitNode(ast);
      }
    };
    init_cjs_shims2();
    var Scope = class {
    ...
    var AssignmentExpression = class extends Visitor {
      visitNode(node) {
        var _a, _b;
        let identifier = (_a = node.left) == null ? void 0 : _a.name;
        let value;
        const currentScope = InterpreterModule.getCurrentScope();
        if (node.right) {
          value = (_b = InterpreterModule.getVisitor(node.right.type)) == null ? void 0 : _b.visitNode(node.right);
        }
      ...
      _getNewvalue(operands, operator) {
        switch (operator) {
          case "=":
    ...
    init_cjs_shims2();
    var BinaryExpression = class extends Visitor {
      visitNode(node) {
        var _a, _b;
        if (node.left && node.right && node.operator) {
          const left2 = (_a = InterpreterModule.getVisitor(node.left.type)) == null ? void 0 : _a.visitNode(node.left);
          const right2 = (_b = InterpreterModule.getVisitor(node.right.type)) == null ? void 0 : _b.visitNode(node.right);
          return this._getValue({ left: left2, right: right2 }, node.operator);
        }
      }
      _getValue(operands, operator) {
        switch (operator) {
          case "+":
            if (checkNumberOperands(operands)) {
              return operands.left + operands.right;
    ...
    init_cjs_shims2();
    var BooleanLiteral = class extends Visitor {
      visitNode(node) {
        return node.value;
      }
    };
    init_cjs_shims2();
    var EmptyStatement = class extends Visitor {
      visitNode(_) {
        return;
      }
    };
    init_cjs_shims2();
    var ExpressionStatement = class extends Visitor {
      visitNode(node) {
        var _a;
        if (node.expression) {
          (_a = InterpreterModule.getVisitor(node.expression.type)) == null ? void 0 : _a.visitNode(node.expression);
        }
      }
    };
    init_cjs_shims2();
    var IdentifierExpression = class extends Visitor {
      visitNode(node) {
    ...
    init_cjs_shims2();
    var InitStatement = class extends Visitor {
      visitNode(node) {
        var _a;
        if (Array.isArray(node.body)) {
          (_a = node.body) == null ? void 0 : _a.forEach((statement) => {
            var _a2;
            (_a2 = InterpreterModule.getVisitor(statement.type)) == null ? void 0 : _a2.visitNode(statement);
          });
        }
      }
    };
    init_cjs_shims2();
    var NullLiteral = class extends Visitor {
      visitNode(node) {
        return node.value;
      }
    };
    init_cjs_shims2();
    var NumericLiteral = class extends Visitor {
      visitNode(node) {
        return node.value;
      }
    };
    init_cjs_shims2();
    var PrintStatement = class extends Visitor {
      visitNode(node) {
        var _a;
        const value = (_a = node.expressions) == null ? void 0 : _a.map((expression) => {
          var _a2;
          return (_a2 = InterpreterModule.getVisitor(expression.type)) == null ? void 0 : _a2.visitNode(expression);
        }).join("");
        console.log(value);
      }
    };
    init_cjs_shims2();
    var Program = class extends Visitor {
      visitNode(node) {
        var _a, _b, _c;
        if (!Array.isArray(node.body) && ((_a = node.body) == null ? void 0 : _a.type)) {
          (_c = InterpreterModule.getVisitor((_b = node.body) == null ? void 0 : _b.type)) == null ? void 0 : _c.visitNode(node.body);
        }
      }
    };
    init_cjs_shims2();
    var StringLiteral = class extends Visitor {
      visitNode(node) {
        return node.value;
      }
    };
    init_cjs_shims2();
    var VariableDeclaration = class extends Visitor {
      visitNode(node) {
        var _a, _b;
        if (node.id && node.init) {
          const identifier = (_a = node.id) == null ? void 0 : _a.name;
          const value = (_b = InterpreterModule.getVisitor(node.init.type)) == null ? void 0 : _b.visitNode(node.init);
          const currentScope = InterpreterModule.getCurrentScope();
          if (identifier) {
    ...
    init_cjs_shims2();
    var VariableStatement = class extends Visitor {
      visitNode(node) {
        var _a;
        (_a = node.declarations) == null ? void 0 : _a.forEach((declaration) => {
          var _a2;
          (_a2 = InterpreterModule.getVisitor(declaration.type)) == null ? void 0 : _a2.visitNode(declaration);
        });
      }
    };
    var _InterpreterModule = class {
      ...
      static getInterpreter() {
        var _a;
        this._interpreter = (_a = this._interpreter) != null ? _a : new Interpreter(import_bhai_lang_parser.default, this.getCurrentScope());
    ...
    InterpreterModule._visitorMap = {
      [import_bhai_lang_parser.NodeType.Program]: new Program(),
      [import_bhai_lang_parser.NodeType.InitStatement]: new InitStatement(),
      [import_bhai_lang_parser.NodeType.PrintStatement]: new PrintStatement(),
      [import_bhai_lang_parser.NodeType.EmptyStatement]: new EmptyStatement(),
      [import_bhai_lang_parser.NodeType.BlockStatement]: new BlockStatement(),
      [import_bhai_lang_parser.NodeType.VariableStatement]: new VariableStatement(),
      [import_bhai_lang_parser.NodeType.IdentifierExpression]: new IdentifierExpression(),
      [import_bhai_lang_parser.NodeType.VariableDeclaration]: new VariableDeclaration(),
      [import_bhai_lang_parser.NodeType.AssignmentExpression]: new AssignmentExpression(),
      [import_bhai_lang_parser.NodeType.ExpressionStatement]: new ExpressionStatement(),
      [import_bhai_lang_parser.NodeType.BinaryExpression]: new BinaryExpression(),
      [import_bhai_lang_parser.NodeType.StringLiteral]: new StringLiteral(),
      [import_bhai_lang_parser.NodeType.NumericLiteral]: new NumericLiteral(),
      [import_bhai_lang_parser.NodeType.BooleanLiteral]: new BooleanLiteral(),
      [import_bhai_lang_parser.NodeType.NullLiteral]: new NullLiteral()
    };
