...
const tokenExecutorMock = new (<new () => TokenExecutor>TokenExecutor)() as jest.Mocked<TokenExecutor>;

const statementListMock = new (<new () => StatementList>StatementList)() as jest.Mocked<StatementList>;
